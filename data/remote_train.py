...
class remote_train():
    ...
    def __init__(self, args, transform=None, k_shot=1):
        ...
        self.data_list_dir = '/data0/mxy/linchungang/SDM/iSAID_patches/train/train_list'
        self.img_dir = os.path.join(settings.DATA_DIR, 'SDM/iSAID_patches/train/', 'images/')
        self.mask_dir = os.path.join(settings.DATA_DIR, 'SDM/iSAID_patches/train/', 'semantic_png/')
